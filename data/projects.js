const projects = [
    ...
    {
      id: 'other-2',
      title: 'Unix Shell Replicate',
      description: 'Recreated the core functionality of a command-line interface focusing on process management, system resource handling, and user interaction.',
      tags: ['Low-level Programming', 'C++', 'CPU', 'Task Management'],
      github: 'https://github.com/filippociandy10/379_assignment1/tree/main/379_assignment1',
      featured: false,
    },
    {
      id: 'other-3',
      title: 'OldHabitsDieHard',
      description: 'A habit tracking application developed for Android devices using Java and Android Studio.',
      tags: ['Java','Android Studio', 'Firebase', 'JUnit'],
      github: 'https://github.com/CMPUT301F21T36/OldHabitsDieHard',
      featured: false,
    },
    {
      id: 'other-4',
